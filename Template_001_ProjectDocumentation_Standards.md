...
## References
 ...
 + [Buffer Overflow Attack from OWASP](https://www.owasp.org/index.php/Buffer_overflow_attack)
 + [DSRC Main Site from Navy Defense Shared Resource Center](https://navydsrc.hpc.mil)
 + [Fail Securely retrieved from OWASP](https://www.owasp.org/index.php/Fail_securely)
 + [Failing Securely from US-CERT](https://www.us-cert.gov/bsi/articles/knowledge/principles/failing-securely)
 + [File Verification from Wikipedia.org](https://en.wikipedia.org/wiki/File_verification)
 + [MIL-STD-498 from Wikipedia.org](https://en.wikipedia.org/wiki/MIL-STD-498)
 + [Ports Protocols Services Manual (PPSM) from DISA](https://www.disa.mil/Network-Services/Enterprise-Connections/PPSM)
 + [Semantic Versioning from semver.org](https://semver.org/)
